...
liste = os.listdir("/CMF/data/timtey/results_contrastive_learning_060723")
...
for i in range(len(liste)):
    matrix = torch.load(f"/CMF/data/timtey/results_contrastive_learning_060723/{liste[i]}")
...
torch.save(threedtsne_results, "threedtsne_results_contrastive_learning_060723.pt")
torch.save(threedtsne_results_lights, "threedtsne_results_lights_contrastive_learning_060723.pt")
...
for i in range(len(threedtsne_results_lights)):
    ...
    ax.axes.set_xlim3d(left=-0.1, right=0.6)
    ax.axes.set_ylim3d(bottom=-0.04, top=0.08)
