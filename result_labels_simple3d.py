...
liste = os.listdir("/CMF/data/timtey/results_contrastive_learning_060523_3d")
...
for i in range(len(liste)):
    matrix = torch.load(f"/CMF/data/timtey/results_contrastive_learning_060223/{liste[i]}")
...
ax
threedtsne = TSNE(n_components=3, perplexity=206)
tsne = TSNE(n_components=2, perplexity=206)
...
torch.save(tsne_results, "tsne_results_contrastive_learning_060223_before_normalisation.pt")
torch.save(tsne_results_lights, "tsne_results_lights_contrastive_learning_060223_before_normalisation.pt")
...
torch.save(threedtsne_results, "threedtsne_results_contrastive_learning_060223.pt")
torch.save(threedtsne_results_lights, "threedtsne_results_lights_contrastive_learning_060223.pt")
